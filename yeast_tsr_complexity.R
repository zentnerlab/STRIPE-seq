...
if (!dir.exists(file.path(baseDir, "yeast_work/TSR_complexity/"))){
  print("Creating directory 'yeast_work/TSR_complexity' and changing working directory...")
  dir.create(file.path(baseDir, "yeast_work/TSR_complexity/"))
  setwd(file.path(baseDir, "yeast_work/TSR_complexity/"))
} else {
  print("Directory 'yeast_work/TSR_complexity' already exisits, changing working directory...")
  setwd(file.path(baseDir, "yeast_work/TSR_complexity/"))
}
...
promoters <- promoters(genes(TxDb.Scerevisiae.UCSC.sacCer3.sgdGene), upstream = 250, downstream = 100)
