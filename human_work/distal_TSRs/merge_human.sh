...
bamCoverage -b H3K27ac_merged.bam -of bigwig -o H3K27ac_merged.spikenorm.bw -bs 25 --scaleFactor .00981 -p 8 -e

bamCoverage -b H3K4me1_merged.bam -of bigwig -o H3K4me1_merged.spikenorm.bw -bs 25 --scaleFactor .51813 -p 8 -e

bamCoverage -b H3K4me2_merged.bam -of bigwig -o H3K4me2_merged.spikenorm.bw -bs 25 --scaleFactor .12680 -p 8 -e

bamCoverage -b H3K4me3_merged.bam -of bigwig -o H3K4me3_merged.spikenorm.bw -bs 25 --scaleFactor .05466 -p 8 -e

bamCoverage -b IgG_merged.bam -of bigwig -o IgG_merged.spikenorm.bw -bs 25 --scaleFactor .00354 -p 8 -e